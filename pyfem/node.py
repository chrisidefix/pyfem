...
class CollectionNode(list):
    ...
    def _with_attr(self, attr, val=None, opt=None):
        """
        ...
        if attr in ['x', 'y', 'z']:
            ...
            if opt is None:
                ...
                return CollectionNode(n for n in self if opt(getattr(n,attr),val))
    ...
    #def sub_gt(self, **kwargs):
    #    """
    #    Filters the collection according to greater than criterion
    #    ==========================================================
    #    EXAMPLES:
    #        tmp = nodes.sub_gt(x=0)
    #        tmp = nodes.sub_gt(x=2).sub_lt(x=4)
    #        tmp = nodes.sub_ge(x=2).sub_le(x=4)
    #    """
    ...
    #    for key, value in kwargs.iteritems():
    #        coll = coll + self._with_attr(key, value, gt)

    #    return coll

    #def sub_lt(self, attr, value):
    #    pass
